	...
	<div class="container">
		...
		<div class="blog-top">
			<div class="col-md-12 blog-left">
				<div class="blog-main">
					<a href="single.html" class="bg">{{ $product->title }}</a>
					<p>Post by <a href="#">Admin</a> {{ $product->created_at->toFormattedDateString() }} </p>
				</div>
				<div class="blog-main-one">
					...
					<div class="blog-comments">
						<ul>
							<li><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span><p>{{ $product->created_at->toFormattedDateString() }}</p></li>
