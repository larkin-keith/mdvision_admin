        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-4">产品管理</div>
                        <div class="col-md-1 col-md-offset-7">
                            <a href="/products/create" class="btn btn-primary btn-xs edit">+ 添加</a>
                        </div>
                    </div>
...
<script>
$(function() {
    var _products = $('#products-table');

    var table = _products.DataTable({
        processing: true,
        serverSide: true,
        ...
        columns: [
            ...
            { data: 'operator', name: 'operator', render: function(data, type, full, meta) {
                return '<a href="/products/'+full.id+'" class="btn btn-primary btn-xs edit">编辑</a>\
    ...
    _products.on( 'click', 'a.delete', function () {
    ...
    _products.on('click', 'a.isEnable', function () {
        var id = table.row( $(this).closest('tr') ).data().id
        // console.log(id)
        var url = '/products/' + id + '/isEnable';
        $.ajax({
            url: url,
            type: 'put',
            success: function() {
