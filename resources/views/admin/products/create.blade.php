                        ...
                        <form action="{!! route('products.store') !!}" method="post" id="myform">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <image src="holder.js/175x125?text=点击上传图片 \n 350x250" width=175 height=125 id="productImage"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="infomation" id="infomation" placeholder="Review..."></textarea>
                                    <span id="helpBlock" class="help-block">请填写产品简要。</span>
                                </div>
                                <div class="form-group">
